...
# To clear the content from the text boxes
def clear():
...
def insert():
    ...
    address_field.get()==""):
        ...
        # assigning the maximum row and maximum column value
        # upto which data is written in an excel sheet to the variable
        current_row = sheet.max_row
        current_column = sheet.max_column
        # get method returns current text as string in which we write intro
...
# grid method is used for placing the widgets at the respective position
